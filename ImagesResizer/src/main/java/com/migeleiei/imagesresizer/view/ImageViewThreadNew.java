...
public class ImageViewThreadNew extends Thread {
    ...
    private ObjectProperty<ImageViewWithPosition> stackPaneObjectProperty = new SimpleObjectProperty<>();

    public ImageViewThreadNew(VBox newLeftPane,
...
//                root.getChildren().add(imageV);
    ...
    @Override
    public void run() {
        StackPane stackPane = imageViewBufferedImage(this.imgModel, this.intColumn);

        ImageViewWithPosition imageViewWithPosition = new ImageViewWithPosition();
        imageViewWithPosition.setColumnIndex(this.columnIndex);
        imageViewWithPosition.setRowIndex(this.rowIndex);
        imageViewWithPosition.setStackPane(stackPane);

        this.stackPaneObjectProperty.set(imageViewWithPosition);
    }

    public ObjectProperty<ImageViewWithPosition> stackPaneObjectProperty() {
        return this.stackPaneObjectProperty;
    }
}
